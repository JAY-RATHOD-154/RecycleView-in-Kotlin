...
class ProductsAdapter(private var products : ArrayList<Product>,private var users:ArrayList<User>) :
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is ProductViewHolder) {
            ...
            var txtViewProductTitle =
                holder.itemView.findViewById<TextView>(R.id.txtViewProductTitle)
            txtViewProductTitle.text = product.productTitle
            holder.itemView.findViewById<TextView>(R.id.txtViewProductPrice).text =
                "" + product.productPrice
            holder.itemView.findViewById<ImageView>(R.id.imgView1)
